...
if (!$controller->is_form_defined() || empty($options['alwaysshowdefinition'])) {
    throw new moodle_exception('nopermissions', 'error', '', get_string('previewmarkingbtec', 'gradingform_btec'));
}
...
echo $OUTPUT->box($controller->get_formatted_description(), 'gradingform_btec-description');
