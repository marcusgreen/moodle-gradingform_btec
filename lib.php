...
class gradingform_btec_controller extends gradingform_controller {
	...
	public function extend_settings_navigation(settings_navigation $settingsnav, navigation_node $node=null) {
		$node->add(get_string('definemarkingbtec', 'gradingform_btec'),
				$this->get_editor_url(), settings_navigation::TYPE_CUSTOM,
				null, null, new pix_icon('icon', '', 'gradingform_btec'));
	}
...
class gradingform_btec_instance extends gradingform_instance {
	...
	*/
	...
	public function get_grade() {
		...
		$levels = array("P"=>1,"M"=>1,"D"=>1);
		/* default to distinction if there are no zeroes in the scores */
	...
	public function render_grading_element($page, $gradingformelement) {
		...
		$html .= $this->get_controller()->get_renderer($page)->display_btec($criteria, $comments, $options, $mode,
